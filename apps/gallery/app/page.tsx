  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <header className="px-6 py-5 max-w-6xl mx-auto flex justify-between items-center">
        <a href={PORTFOLIO_URL} className="text-xs font-bold uppercase tracking-widest text-slate-400 hover:text-white transition-colors">
          ← Prasad Jawale
        </a>
        <Link href="/admin" className="text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-white transition-colors">
          Admin
        </Link>
      </header>
      ...
      <section className="px-6 pb-12">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 text-slate-600">
            ...
            <p className="text-sm uppercase tracking-widest">No photos yet — start the API and upload some</p>
          </div>
        ) : (
          <>
