...
import { Menu, X , User, Mail, Code, Terminal, Camera,  Linkedin, ChevronRight, Globe, GitHub, GitBranch} from 'react-feather';
...
function TempPage() {
    ...
    // const [data,setData] = useState({});
      ...
      // useEffect(() => {
      //   fetch("https://portfolio-backend-server-phi.vercel.app/api/data")
      //     .then((res) => {
      //       if (!res.ok) throw new Error(`HTTP error! Status: ${res.status}`);
      //       return res.json();
      //     })
