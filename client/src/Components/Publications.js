      ...
      <div class="p-10 items-start min-h-screen">
        ...
        <div>
          {publications.map((publication) => (
            <div
              key={publication.id}
              className="w-full rounded-3xl text-justify overflow-hidden shadow-lg bg-white flex flex-col md:flex-row mb-4 hover:bg-gray-100"
            >
              <div className="w-full p-5">
                <div className="">
                  ...
                  <p className="text-gray-600 text-lg p-5">
