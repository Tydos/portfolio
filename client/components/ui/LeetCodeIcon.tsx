...
/**
 * LeetCode brand mark (orange glyph, gray bar, black accent).
 *
 * Paths align with the widely used Devicon `leetcode-original` artwork.
 *
 * @param props.size - Icon width/height in pixels.
 * @param props.className - Optional SVG class names.
 */
function LeetCodeIcon({ size = 24, className }: LeetCodeIconProps) {
  return (
    <svg
