"Fallback data for the case where the database is unavailable. This allows the API to remain functional and return sample photographs even if the database connection fails."
